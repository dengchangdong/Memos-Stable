    ...
    <div className="w-full border mt-2 py-2 px-3 rounded-md space-y-0.5 text-gray-500 dark:text-gray-400 bg-zinc-50 dark:bg-zinc-900 dark:border-zinc-800">
      ...
      <div className="w-full flex justify-between items-center">
        <div className="w-full flex justify-start items-center">
          ...
          <span className="block text-base sm:text-sm">{t("stats.days")}</span>
        </div>
      ...
      <div className="w-full flex justify-between items-center">
        <div className="w-full flex justify-start items-center">
          ...
          <span className="block text-base sm:text-sm">{t("stats.memos")}</span>
        </div>
      ...
      <div className="w-full flex justify-between items-center">
        <div className="w-full flex justify-start items-center">
          ...
          <span className="block text-base sm:text-sm">{t("stats.tags")}</span>
        </div>
